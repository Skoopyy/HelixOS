...
title HelixOS Core Installer Backend
echo Starting installation...
title HelixOS HMK Edition Installer Backend
echo.
cd /
md HelixOS
cd HelixOS
md HMK
cd HMK
powershell curl https://raw.githubusercontent.com/Skoopyy/HelixOS/main/bin/hmk/PostInstall.bat -O PostInstall.bat > nul
powershell curl https://github.com/Skoopyy/HelixOS/raw/main/bin/hmk/HelixOSPostInstall.exe -O HelixOSPostInstall.exe > nul
powershell curl https://raw.githubusercontent.com/Skoopyy/HelixOS/main/bin/hmk/defaultwallpaper.jpg -O DefaultWallpaper.jpg > nul
...
reg add "HKLM\SOFTWARE\Microsoft\Windows\CurrentVersion\OEMInformation" /v "Model" /t REG_SZ /d "HelixOS Core" /f >nul
cls
...
reg add "HKLM\SOFTWARE\Microsoft\Windows\CurrentVersion\OEMInformation" /v "Manufacturer" /t REG_SZ /d "Skoopyy" /f >nul
cls
reg add "HKLM\SOFTWARE\Microsoft\Windows\CurrentVersion\OEMInformation" /v "Model" /t REG_SZ /d "HelixOS HMK Edition" /f >nul
cls
